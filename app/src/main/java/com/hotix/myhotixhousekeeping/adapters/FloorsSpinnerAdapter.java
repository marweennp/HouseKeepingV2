...
public class FloorsSpinnerAdapter extends BaseAdapter {

    Context context;
    ArrayList<Etage> mData;
    LayoutInflater inflter;

    public FloorsSpinnerAdapter(Context applicationContext, ArrayList<Etage> mData) {

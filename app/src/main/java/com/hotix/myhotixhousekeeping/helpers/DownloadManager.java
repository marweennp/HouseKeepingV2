...
import com.hotix.myhotixhousekeeping.BuildConfig;
    ...
    public void install() {
        if (downloaded) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
                ...
                Uri fileUri = FileProvider.getUriForFile(mContext, BuildConfig.APPLICATION_ID, saveFile);
